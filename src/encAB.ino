...
// ros::Publisher pub("encoder", &encoder);
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(encoderPinA1), readEncoder, CHANGE);               // update encoder position
