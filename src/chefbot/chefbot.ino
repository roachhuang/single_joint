...
//PIN NUMBER ON 'IN' IS REVERSE
  ...
  #define MOTOR_LEFT_ENA 6   // Connected to driver ena
  #define MOTOR_LEFT_IN1 7
  #define MOTOR_LEFT_IN2 8


  #define MOTOR_RIGHT_ENB 9  //Connected to driver enb
 ...
 */
  ...
  #define MOTOR_ENCODER_LEFT 2
  #define MOTOR_ENCODER_LEFT_NO 5
  
  #define MOTOR_ENCODER_RIGHT 3 
  #define MOTOR_ENCODER_RIGHT_NO 4
...
void setup() {
    ...
    Setup_Serial(57600,usb_serial_enable_bit,ble_serial_enable_bit);
