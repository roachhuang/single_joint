...
from std_msgs.msg import Float32MultiArray, Int32, Int64, Float32, String, Header, UInt64
...
#Subscribers and Publishers
		...
		self._Left_Encoder = rospy.Publisher('lwheel',Int32,queue_size = 10)		
		self._Right_Encoder = rospy.Publisher('rwheel',Int32,queue_size = 10)		
