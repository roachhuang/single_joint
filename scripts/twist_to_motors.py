...
class TwistToMotors():
    ...
    def __init__(self):
        ...
        self.w = rospy.get_param("wheel_separation", 0.15)

        self.pub_lmotor = rospy.Publisher('lwheel_vtarget', Float64,queue_size=10)
        self.pub_rmotor = rospy.Publisher('rwheel_vtarget', Float64,queue_size=10)
    ...
    def spinOnce(self):
        ...
        self.right_mapped = interp(self.right, [-1, 1], [-45, 45])
        self.left_mapped = interp(self.left, [-1, 1], [-45, 45])
        ...
        self.pub_lmotor.publish(self.speed_data.data[0])
        self.pub_rmotor.publish(self.speed_data.data[1])
